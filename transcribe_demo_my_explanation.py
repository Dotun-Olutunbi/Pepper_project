...
def main():
    ...
    # The microphone audio is delivered as a sequence of bytes (little-endian 16-bit samples), 
    #keeping it as a bytes object allows me to append new chunks without converting to higher-level structures until I'm ready to transcribe.
